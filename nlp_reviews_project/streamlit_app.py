...
from streamlit_topics import main as show_topics_page
...
page = st.sidebar.selectbox('Page', ['Overview', 'EDA — Statistical comparison', 'Topics — Pros/Cons'])
...
elif page == 'Topics — Pros/Cons':
    show_topics_page()
else:
    # Overview page
    data_path = st.text_input('Path to feature CSV', 'nlp_reviews_project/data/feature_reviews.csv')
    if data_path:
        try:
